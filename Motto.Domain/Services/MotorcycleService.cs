...
namespace Motto.Services
{
    ...
    public class MotorcycleService : IMotorcycleService
    {
        ...
        public async Task<ServiceResult<string>> CreateMotorcycle(Motorcycle model, MotorcycleEventProducer? motorcycleEventProducer)
        {
            var existingPlateMotorcycle = await _motorcycleRepository.HasPlate(model.Plate, 0);
        ...
        public async Task<ServiceResult<string>> UpdateMotorcycle(int id, Motorcycle model)
        {
