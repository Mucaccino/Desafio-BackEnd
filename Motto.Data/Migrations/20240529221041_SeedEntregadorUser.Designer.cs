...
namespace entities.Migrations
{
    ...
    [Migration("20240529221041_SeedEntregadorUser")]
    partial class SeedEntregadorUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Motto.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Administrador",
                            PasswordHash = "0wMR4IyBWMUJXaEQmtV1ZH8oHLMQRiKyBF2a9eaxt2c=",
                            Salt = "Zrho4xwvwpcv12uGF01CeQ==",
                            Type = 0,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Motto.Entities.DeliveryDriverUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            Name = "Entregador",
                            PasswordHash = "xVrDAHWamtmDMw4fx9Z7np5XAs1Rd+CACDZ8PFlMyZ4=",
                            Salt = "89wSBBwN7kHV6t/kvSJwOA==",
                            Type = 1,
                            Username = "entregador",
                            CNPJ = "12345678901234",
