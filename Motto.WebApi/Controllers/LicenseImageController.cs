...
namespace Motto.Controllers
{
    ...
    public class LicenseImageController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="deliveryDriverUserRepository">The repository for accessing delivery driver data.</param>
        /// <param name="licenseImageService">The service for handling license image operations.</param>
        /// <param name="logger">The logger.</param>
        public LicenseImageController(IDeliveryDriverUserRepository deliveryDriverUserRepository, ILicenseImageService licenseImageService, ILogger<LicenseImageController> logger)
        {
        ...
        public async Task<IActionResult> UploadImage(int id, IFormFile image)
        {
            ...
            var driver = await _deliveryDriverUserRepository.GetById(id);
            if (driver == null)
            {
            ...
            try
            {
                ...
                await _deliveryDriverUserRepository.Update(driver);
        ...
        {
            var deliveryDriver = await _deliveryDriverUserRepository.GetById(id);
            if (deliveryDriver == null || string.IsNullOrEmpty(deliveryDriver.DriverLicenseImage))
            {
                return NotFound();
            }
